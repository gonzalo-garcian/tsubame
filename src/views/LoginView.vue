...
<template>
  ...
  >
    <div class="flex flex-1 flex-col items-center">
      ...
      <div class="w-full rounded-lg shadow border max-w-md p-0 bg-gray-700 border-gray-700 drop-shadow-personalize-up">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <form class="space-y-4 md:space-y-6" @submit.prevent="handleLogin">
            ...
            <button type="submit" class="w-full text-white bg-purple-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
            <p class="text-sm font-light text-white">
              Don’t have an account yet? <a href="/dashboard" class="font-medium text-white hover:underline">Sign up</a>
            </p>
          </form>
        </div>
      </div>
